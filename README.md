# 🔒 SafeView - AI 内容安全检测工具

<div align="center">

![SafeView Logo](./public/logo.svg)
...
**SafeView** 是一款完全在浏览器端运行的 AI 内容安全检测工具，能够智能识别图片和视频中是否包含不适宜展示的内容（NSFW - Not Safe For Work）。

### ✨ 核心亮点

- 🔐 **隐私优先**：所有处理均在本地浏览器完成，文件不会上传到任何服务器
- ⚡ **快速高效**：利用 GPU 加速，图片检测仅需数十毫秒
- 🎯 **精准识别**：基于深度学习模型，支持 5 种内容分类
...
A: SafeView 使用的是经过大量数据训练的深度学习模型，在大多数情况下能提供准确的判断。但没有任何 AI 系统能做到 100% 准确，建议将检测结果作为参考，重要场景仍需人工复核。
...
A: 完全可以！SafeView 采用响应式设计，在手机、平板上都有良好的使用体验。不过由于移动端性能限制，检测速度可能会稍慢。
...
- [NSFW.js](https://github.com/infinitered/nsfwjs) - 提供核心的 NSFW 检测模型
...
1. 本工具仅供学习和参考使用，检测结果的准确性不能得到完全保证
2. 请勿将本工具用于非法用途
